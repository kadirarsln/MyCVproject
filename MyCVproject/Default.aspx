<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MyCVproject.Default" %>
...
<head>
    ...
    <link href="Folder/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="Folder/css/resume.min.css" rel="stylesheet">
</head>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            <span class="d-block d-lg-none">Kadir Şehmus Arslan</span>
            <span class="d-none d-lg-block">
                <asp:Repeater ID="Repeater7" runat="server">
                    <ItemTemplate>
                        <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src='<%# Eval("FOTOGRAFD") %>' alt=""></ItemTemplate>
                </asp:Repeater>
            </span>
        </a>
    ...
    <script src="Folder/js/resume.min.js"></script>
